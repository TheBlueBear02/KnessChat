...
def display_user_message(tweet,all_tweets):
    ...
    <div style="display: flex; flex-direction: column; align-items: {alignment}; margin-top: 4px;">
        <div style="max-width: 70%; margin: 5px; padding: 10px; background-color: {background_color}; border-radius: {border_radius}; color: {text_color}; text-align: right">
            <table style="direction: {table};">
                <tr style="border: none;"> 
                    <th style="border: none; text-align: {halign};">
                        ...
                        <i style="margin-left: 0px;">{profile["party"]}</i>
                    </th>
                ...
                <tr style="border: none;">
                    ...
                    <p dir= "rtl" style="margin-top: 10px; color: {text_color};">{tweet["Text"]}</p>
                    <p style="color: {text_color}; text-align: {talign}; font-size: small;">{tweet["Time"]}</p></td>
